...
function modificarUno() {
    require 'bbdd.php';
    // Incluimos fichero en la que está la coenxión con la BBDD
    require 'jsonEsperadoDispensadoresGuardar.php';
    ...
    */
    ...
    if ( isset( $parameters ) ) {
        ...
        if ( JSONmodificar( $mensajeRecibido ) == true ) {
            ...
            $dispensador = $mensajeRecibido['dispensadorGuardar'];
            ...
            $query  = "UPDATE dispensadores SET cantidad = '$cantidad' WHERE clave = '$clave'";
            ...
            if ( isset ( $result ) && $result ) {
                ...
                $arrMensaje['estado'] = 'ok';
                $arrMensaje['mensaje'] = 'Dispensador mofificado correctamente';
